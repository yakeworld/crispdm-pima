...
\begin{enumerate}[nosep]
    \item We introduce the \textbf{CRISP-DM Helix}: the first formalized, auditable data isolation protocol, defined as a 5-tuple with complete algorithmic implementation (Algorithm 1), aligned with PROBAST risk domains.
    \item We provide the \textbf{first quantitative measurement of protocol violation effects}, showing that failure to implement the Helix inflates F1-Score by $+8.6\%$ while decreasing clinical Recall.
